...
* [HelpTextProvider](help.md) can be overridden to make targetted changes to a section of help.
...
* [Password](passwords.md) type added to prevent accidental logging of password values and hide passwords during prompting.
